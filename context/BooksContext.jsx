...
const initialBooks = [
  ...
  },
  {
    ...
    isFree: false,
    coverImage: book2,
    pdfFile: `${API_URL}/media/books/pdfs/85jkr_harrypotter_1.pdf`,
  ...
  },
  {
    ...
    isFree: true,
    coverImage: book3,
    pdfFile: `${API_URL}/media/books/pdfs/Dune Messiah - Frank Herbert.pdf`,
  ...
  },
  {
    ...
    isFree: false,
    coverImage: book5,
    pdfFile: `${API_URL}/media/books/pdfs/Stieg Larsson - Millenium 01 - The Girl With The Dragon Tatoo PDF.pdf`,
  ...
  },
  {
    ...
    isFree: true,
    coverImage: book6,
    pdfFile: `${API_URL}/media/books/pdfs/And Then There Were None.pdf`,
  ...
  },
  {
    ...
    isFree: false,
    coverImage: book9,
    pdfFile: `${API_URL}/media/books/pdfs/The Da Vinci Code.pdf`,
  ...
  },
  {
    ...
    isFree: false,
    coverImage: book13,
    pdfFile: `${API_URL}/media/books/pdfs/On Writing_ A Memoir of the Craft - Stephen King.pdf`,
