...
const initialBooks = [
  ...
  },
  {
    ...
    isFree: false,
    coverImage: book2,
    pdfFile: 'http://127.0.0.1:8000/media/books/pdfs/harry_potter.pdf',
  ...
  },
  {
    ...
    isFree: true,
    coverImage: book3,
    pdfFile: 'http://127.0.0.1:8000/media/books/pdfs/Dune%20Messiah%20-%20Frank%20Herbert.pdf',
  ...
  },
  {
    ...
    isFree: false,
    coverImage: book5,
    pdfFile: 'http://127.0.0.1:8000/media/books/pdfs/Stieg%20Larsson%20-%20Millenium%2001%20-%20The%20Girl%20With%20The%20Dragon%20Tatoo%20PDF.pdf',
  ...
  },
  {
    ...
    isFree: true,
    coverImage: book6,
    pdfFile: 'http://127.0.0.1:8000/media/books/pdfs/And%20Then%20There%20Were%20None.pdf',
  ...
  },
  {
    ...
    isFree: false,
    coverImage: book9,
    pdfFile: 'http://127.0.0.1:8000/media/books/pdfs/The%20Da%20Vinci%20Code.pdf',
  ...
  },
  {
    ...
    isFree: false,
    coverImage: book13,
    pdfFile: 'http://127.0.0.1:8000/media/books/pdfs/On%20Writing_%20A%20Memoir%20of%20the%20Craft%20-%20Stephen%20King.pdf',
